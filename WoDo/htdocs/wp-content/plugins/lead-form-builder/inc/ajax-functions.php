           ...
           // $table_head = '';
            ...
            $returnData = $th_save_db->lfb_lead_form_value($form_data,$fieldIdNew,$fieldData,$leadscount);
              ...
              //  $complete_data .=$returnData['table_popup']."</table>";
               ...
               $table_body  .='<tr><td><span class="lead-count">' . $sn_counter . '</span><a class="lead-remove" onclick="delete_this_lead(' . $lead_id . ')" ><i class="fa fa-trash" aria-hidden="true"></i></a></td>' . $table_row .$date_td.'</tr>';
            }
